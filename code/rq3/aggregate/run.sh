...
#SBATCH --output=/data/home/djbf/storage/bls/rq3/logs/%j/metrics_agg.out
#SBATCH --error=/data/home/djbf/storage/bls/rq3/logs/%j/metrics_agg.err
#SBATCH --time=4:00:00

#===============================================================================
# Biomedical Language Simplification (BLS) - Metrics Aggregator for RQ3
...
Examples:
  ...
  sbatch run.sh --datasets claude --exclude "**/test/**/*.json"
EOF
    exit 1
}
...
get_pattern() {
    case "$1" in
        "baseline") echo "phase2/baseline/**/readability_metrics.json" ;;
        "fewshot") echo "phase2/fewshot/**/readability_metrics.json" ;;
        "finetuned") echo "phase2/finetuned/**/readability_metrics.json" ;;
        "finetuned3b") echo "phase2/finetuned3b/**/readability_metrics.json" ;;
        "finetunedIt") echo "phase2/finetunedIt/**/readability_metrics.json" ;;
        "claude") echo "phase2/claude/**/readability_metrics.json" ;;
        "baseline+fewshot+finetuned+finetunedIt+claude") echo "phase2/**/readability_metrics.json" ;;
...
run_aggregation() {
    ...
    local output_file="$OUTPUT_DIR/phase2/$dataset/aggregated_metrics.json"
    local pattern
...
OUTPUT_DIR="$HOME_DIR/storage/bls/rq3/outputs"
LOGS_DIR="$HOME_DIR/storage/bls/rq3/logs/$SLURM_JOB_ID"
...
AVAILABLE_DATASETS=("baseline" "fewshot" "finetuned" "finetuned3b" "finetunedIt" "claude" "baseline+fewshot+finetuned+finetunedIt+claude")
...
for dataset in "${process_datasets[@]}"; do
    output_file="$OUTPUT_DIR/phase2/$dataset/aggregated_metrics.json"
